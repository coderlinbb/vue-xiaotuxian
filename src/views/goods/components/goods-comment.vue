  ...
  <div class="goods-comment">
    ...
    <div class="head" v-if="commentInfo">
      ...
      <div class="tags">
        ...
        <div class="dd">
          <a v-for="(item,i) in commentInfo.tags" :key="item.title" href="javascript:;" :class="{active:currTagIndex===i}" @click="changeTag(i)">
...
const getCommentInfo = goods => {
  ...
  findCommentInfoByGoods(goods.id).then(data => {
    ...
    data.result.tags.unshift({ type: 'img', title: '有图', tagCount: data.result.hasPictureCount, type: 'img' })
    data.result.tags.unshift({ type: 'all', title: '全部评价', tagCount: data.result.evaluateCount, type: 'all' })
